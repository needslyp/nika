...
export class ServerRoot {
    ...
    private _userMessageController: UserMessageController = null;
    ...
    public Start(): void {
        ...
        this._userMessageController = new UserMessageController(this._client, this._serverKeynodes);
    ...
    public get userMessageController(): UserMessageController {
        return this._userMessageController;
    }
    ...
    public saveAudio(url: string): void {
        this._store.dispatch(store.actions.ui.SaveAudio(url));
    }

    public saveAnswerText(answerText: string): void {
        this._store.dispatch(store.actions.ui.SaveAnswerText(answerText));
    }

    public changeAnswerWaiting(answerWaiting: boolean): void {
        this._store.dispatch(store.actions.ui.ChangeAnswerWaiting(answerWaiting));
    }

    public saveChat(chat: ChatController): void {
        this._store.dispatch(store.actions.ui.SaveChat(chat));
    }
}
