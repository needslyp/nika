...
{
  return m_memoryCtx.HelperCheckEdge(MessageReplyKeynodes::action_reply_to_message, actionAddr, ScType::EdgeAccessConstPosPerm);
}
...
ScAddr MessageReplyAgent::generateAnswer(ScAddr const & messageAddr)
{
  ...
  answerGenerationTemplate.Triple(
      ScType::NodeVarStruct >> ANSWER_ALIAS,
      ScType::EdgeAccessVarPosPerm,
      messageAddr);
  answerGenerationTemplate.Triple(
      ANSWER_ALIAS,
      ScType::EdgeAccessVarPosPerm,
      searchResult[0][REPLY_MESSAGE_RELATION_PAIR_ARC_ALIAS]);
  answerGenerationTemplate.Triple(
      ANSWER_ALIAS,
      ScType::EdgeAccessVarPosPerm,
  ...
  answerGenerationTemplate.Triple(
      ANSWER_ALIAS,
      ScType::EdgeAccessVarPosPerm,
      searchResult[0][REPLY_MESSAGE_RELATION_ACCESS_ARC_ALIAS]);
  answerGenerationTemplate.Triple(
      ANSWER_ALIAS,
      ScType::EdgeAccessVarPosPerm,
      MessageReplyKeynodes::nrel_reply);
...
bool MessageReplyAgent::hasLanguage(ScAddr const & linkAddr)
{
  ...
  languageTemplate.Triple(
      MessageReplyKeynodes::languages,
      ScType::EdgeAccessVarPosPerm,
      ScType::NodeVarClass >> link_language_class);
  languageTemplate.Triple(
      link_language_class,
      ScType::EdgeAccessVarPosPerm,
      linkAddr);
...
bool MessageReplyAgent::soundLinkIsValid(ScAddr const & linkAddr)
{
  ...
  soundLinkTemplate.Triple(
      MessageReplyKeynodes::concept_sound_file,
      ScType::EdgeAccessVarPosPerm,
      linkAddr);
  soundLinkTemplate.Triple(
      MessageReplyKeynodes::format_wav,
      ScType::EdgeAccessVarPosPerm,
      linkAddr);
  ScTemplateSearchResult searchResult;
...
bool MessageReplyAgent::textLinkIsValid(ScAddr const & linkAddr)
{
  ...
  textLinkTemplate.Triple(
      MessageReplyKeynodes::concept_text_file,
      ScType::EdgeAccessVarPosPerm,
      linkAddr);
  ScTemplateSearchResult searchResult;
