...
ScAddr MessageKeynodes::nrel_message_decomposition;
ScAddr MessageKeynodes::nrel_message_sequence;
ScAddr MessageKeynodes::nrel_reply;
ScAddr MessageKeynodes::rrel_message_theme;
ScAddr MessageKeynodes::concept_text_file;
ScAddr MessageKeynodes::template_reply_target;
